...
import (
	...
	"bleve/v2/analysis"
	"bleve/v2/analysis/analyzer/custom"
	"bleve/v2/analysis/analyzer/keyword"
	"bleve/v2/analysis/analyzer/standard"
	html_char_filter "bleve/v2/analysis/char/html"
	regexp_char_filter "bleve/v2/analysis/char/regexp"
	"bleve/v2/analysis/token/length"
	"bleve/v2/analysis/token/lowercase"
	"bleve/v2/analysis/token/shingle"
	"bleve/v2/analysis/tokenizer/single"
	"bleve/v2/analysis/tokenizer/whitespace"
	"bleve/v2/document"
	"bleve/v2/index/scorch"
	"bleve/v2/index/upsidedown"
	"bleve/v2/mapping"
	"bleve/v2/search"
	"bleve/v2/search/highlight/highlighter/ansi"
	"bleve/v2/search/highlight/highlighter/html"
	"bleve/v2/search/query"
)
