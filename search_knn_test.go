...
func getHybridSearchIndex(path string) (Index, error) {
	// Index mapping
	indexMapping := NewIndexMapping()
...
func getHybridSearchRequest() *SearchRequest {
...
func TestRRFEndToEnd(t *testing.T) {
	...
	index, err := getHybridSearchIndex(tmpIndexPath)
	...
	searchRequest := getHybridSearchRequest()
...
func TestRRFAliasWithTwoIndexes(t *testing.T) {
	...
	index1, err := getHybridSearchIndex(tmpIndexPath1)
	if err != nil {
		t.Fatal(err)
	}
	defer func() {
	...
	index2, err := getHybridSearchIndex(tmpIndexPath2)
	if err != nil {
		t.Fatal(err)
	}
	defer func() {
...
func TestRRFNestedAliases(t *testing.T) {
	...
	index3, err := getHybridSearchIndex(tmpIndexPath3)
	if err != nil {
		t.Fatal(err)
	}
	defer func() {
