...
func TestGeoJsonLinestringIntersectsQuery(t *testing.T) {
	tests := []struct {
		...
		{[][]float64{{36.19840621948242, 50.03834418692451},
			{36.25720024108887, 50.02136210283289}}, "geometry",
...
func TestGeoJsonMultiLinestringContainsQuery(t *testing.T) {
	tests := []struct {
		...
		{[][][]float64{{{36.28664016723633, 49.96574238290487},
			{36.30251884460449, 49.96369956194569}}, {{36.19179725646973, 50.03983258984584},
			{36.19420051574707, 50.03801342445342}}}, "geometry",
			[]string{"gc_polygonInGc_multipolygonInGc"}},

		// test a multilinestring query for envelope2.
		{[][][]float64{{{36.23213768005371, 50.02913711386621},
			{36.25187873840332, 50.02902683882067}},
			{{36.231794357299805, 50.018935600613254},
				{36.2314510345459, 50.025883893582055}}}, "geometry",
			[]string{"envelope2"}},
...
func setupGeoJsonShapesIndexForLinestringQuery(t *testing.T) index.Index {
	...
	polygon1 := [][][][]float64{{{{74.84642028808594, 22.402776071459712},
		{74.83234405517578, 22.39039647758608}, {74.86719131469727, 22.38801566009795},
		{74.85139846801758, 22.39103135536648}, {74.86461639404297, 22.394840561182853},
		{74.8495101928711, 22.397697397065034},
		{74.86186981201172, 22.401982540816856}, {74.84642028808594, 22.402776071459712}}}}
	...
	polygon2 := [][][][]float64{{{{74.93431091308592, 22.376428433285266},
		{74.92898941040039, 22.39103135536648}, {74.9241828918457, 22.37722210974017},
		{74.90821838378906, 22.37388863821397}, {74.92504119873047, 22.369920115637292},
		{74.92864608764648, 22.355632497760894}, {74.93207931518555, 22.370396344320053},
	...
	envelope1 := [][][][]float64{{{{74.86736297607422, 22.307361269208684},
	...
	envelope2 := [][][][]float64{{{{36.23007774353027, 50.01810835593541},
	...
	linestring := [][][][]float64{{{{74.92697238922119, 22.320343743143248},
	...
	multilinestring := [][][][]float64{{{{74.92203712463379, 22.3113315728684},
	...
	polygonWithHole2 := [][][][]float64{{
		{{36.261234283447266, 49.90712870720605}, {36.2479305267334, 49.89480027061714},
			{36.254539489746094, 49.883408870659736}, {36.280717849731445, 49.883408870659736},
			{36.28741264343262, 49.890432041848264}, {36.27788543701172, 49.90276159448742},
			{36.261234283447266, 49.90712870720605}},

		{{36.264581680297844, 49.905249238801304}, {36.25368118286133, 49.89673543545543},
			{36.253509521484375, 49.88578690918283}, {36.270332336425774, 49.886174020645804},
	...
	multipolygon1 := [][][][]float64{{{{36.1875057220459, 50.04363607656457},
		{36.192398071289055, 50.034871067327856}, {36.20218276977539, 50.03955696315653},
		{36.1875057220459, 50.04363607656457}}}, // polygon1
		{{{36.2123966217041, 50.03795829715335}, {36.218318939208984, 50.0333273779768},
			{36.226558685302734, 50.03867494711694}, {36.217031478881836, 50.04286437899031},
			{36.2123966217041, 50.03795829715335}}}, // polygon2
		{{{36.221065521240234, 50.00365685169585}, {36.226301193237305, 49.998029518286025},
			{36.23342514038086, 49.9995743420677}, {36.23531341552734, 50.002994846659156},
			{36.231021881103516, 50.00630478067617}, {36.22810363769531, 50.00663576154257},
			{36.226043701171875, 50.004815338573046}, {36.221065521240234, 50.00365685169585}}}}
	...
	polygonInGc := [][][][]float64{{{{36.1875057220459, 50.04363607656457},
		{36.192398071289055, 50.034871067327856}, {36.20218276977539, 50.03955696315653},
		{36.1875057220459, 50.04363607656457}}}}
	multipolygonInGc := [][][][]float64{{{{36.29015922546387, 49.980150089789376},
		{36.28337860107422, 49.961656654293485}, {36.307411193847656, 49.96033147865059},
		{36.29015922546387, 49.980150089789376}}}, // polygon1
		{{{36.16106986999512, 50.00387751801547}, {36.161842346191406, 49.9908012905034},
			{36.17900848388672, 49.99841572888488}, {36.16106986999512, 50.00387751801547}}}}
