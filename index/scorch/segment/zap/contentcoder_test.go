...
func TestChunkContentCoder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expected: string([]byte{0x1, 0x09, 0x1, 0x0, 0x05, 0x00, 0x62, 0x6c, 0x65, 0x76, 0x65}),
		},
		{
			maxDocNum: 1,
			chunkSize: 1,
			...
			expected: string([]byte{0x02, 0x0a, 0x14, 0x01, 0x00, 0x06, 0x00,
				0x75, 0x70, 0x73, 0x69, 0x64, 0x65, 0x01, 0x01, 0x06,
				0x00, 0x73, 0x63, 0x6f, 0x72, 0x63, 0x68}),
		},
	}
